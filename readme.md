...
|   n  |       Algorithm          | Comparisons | Swaps | Messages | Time Steps | Execution Time (s) | Time Complexity | Space Complexity |
|:----:|:-------------------------|------------:|------:|---------:|-----------:|--------------------:|:----------------|:-----------------|
|  10  | Odd-Even Transposition   |          90 |    20 |      180 |         20 |             0.000000 | O(n²)           | O(n)             |
|  10  | Sasaki Time-Optimal      |          45 |     0 |       18 |         18 |             0.000000 | O(n log n)      | O(n)             |
|  10  | Alternative Time-Optimal |          25 |     0 |       18 |         13 |             0.000000 | O(n log n)      | O(n)             |
|      |                          |             |       |          |            |                      |                 |                  |
|  20  | Odd-Even Transposition   |         380 |   180 |      760 |         40 |             0.001421 | O(n²)           | O(n)             |
|  20  | Sasaki Time-Optimal      |         190 |     0 |       38 |         38 |             0.000000 | O(n log n)      | O(n)             |
|  20  | Alternative Time-Optimal |          68 |     0 |       38 |         24 |             0.000000 | O(n log n)      | O(n)             |
|      |                          |             |       |          |            |                      |                 |                  |
|  30  | Odd-Even Transposition   |         870 |   390 |     1740 |         60 |             0.001143 | O(n²)           | O(n)             |
|  30  | Sasaki Time-Optimal      |         435 |     0 |       58 |         58 |             0.000000 | O(n log n)      | O(n)             |
|  30  | Alternative Time-Optimal |         111 |     0 |       58 |         34 |             0.000000 | O(n log n)      | O(n)             |
|      |                          |             |       |          |            |                      |                 |                  |
|  50  | Odd-Even Transposition   |        2450 |  1150 |     4900 |        100 |             0.003019 | O(n²)           | O(n)             |
|  50  | Sasaki Time-Optimal      |        1225 |     0 |       98 |         98 |             0.000000 | O(n log n)      | O(n)             |
|  50  | Alternative Time-Optimal |         222 |     0 |       98 |         55 |             0.000000 | O(n log n)      | O(n)             |
